...
8. Tool contract.
9. Loop contract, если агент выполняет повторяемый процесс.
10. Trigger Lab.
11. Output Eval Lab.
12. Stage quality gates and loop state.
13. Context packaging and subagent budget.
14. Skill Training Lab: workflow ledger, subagent records, skill candidates, promotion gate.
15. Birth contract, first-run sequence, environment readiness, project context, and post-birth cleanup.
16. Target conformance and adapter parity.
17. Final evidence contract and claim guard.
18. Trust, permissions, runtime probes.
19. Memory and workspace policy.
20. Release review.
21. Independent validation.
22. Repair and regress.
23. Package, install, birth gate, export validation.
24. Operations and living adaptation.
