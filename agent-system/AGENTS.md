...
3. Создайте birth contract: runtime profile, birth plan, environment readiness, project context и cleanup policy.
4. Опишите trigger surface: should-trigger, should-not-trigger, near-neighbor, adversarial, confusion, holdout.
5. Спроектируйте router, skills, command/workflow layer, tools, checkers, memory/state, workspace hygiene.
6. Соберите один полный vertical slice.
7. Опишите tool registry и permission matrix.
8. Создайте Trigger Lab и Output Eval Lab.
9. Добавьте context packaging policy.
10. Добавьте release review, evidence ledger и claim guard.
11. Разделите runtime и devkit.
12. Проверьте package/install/birth gate.
13. Только после этого публикуйте или архивируйте.
